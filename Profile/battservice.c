...
static uint8_t battMeasure(void)
{
    ...
    if (Vbat <=4150 && Vbat>4140) {
        percent = 99;
    }
    if (Vbat <=4140 && Vbat>4120) {
            percent = 97;
        }
    if (Vbat <=4120 && Vbat>4110) {
            percent = 95;
        }
    if (Vbat <=4110 && Vbat>4080) {
            percent = 92;
        }
    if (Vbat <=4080 && Vbat>4050) {
            percent = 90;
        }
    if (Vbat <=4050 && Vbat>4030) {
            percent = 87;
        }
    if (Vbat <=4030 && Vbat>3970) {
            percent = 85;
        }
    if (Vbat <=3970 && Vbat>3930) {
            percent = 80;
        }
    if (Vbat <=3930 && Vbat>3900) {
            percent = 75;
        }
    if (Vbat <=3900 && Vbat>3870) {
            percent = 70;
        }
    if (Vbat <=3870 && Vbat>3840) {
            percent = 65;
        }
    if (Vbat <=3840 && Vbat>3810) {
            percent = 60;
        }
    if (Vbat <3810 && Vbat>3790) {
            percent = 55;
        }
    if (Vbat <=3790 && Vbat>3770) {
            percent = 50;
        }
    if (Vbat <=3770 && Vbat>3760) {
            percent = 45;
        }
    if (Vbat <=3760 && Vbat>3755) {
            percent = 42;
        }
    if (Vbat <=3755 && Vbat>3740) {
            percent = 40;
        }
    if (Vbat <=3740 && Vbat>3730) {
            percent = 35;
        }
    if (Vbat <=3730 && Vbat>3720) {
            percent = 30;
        }
    if (Vbat <=3720 && Vbat>3710) {
            percent = 25;
        }
    if (Vbat <=3710 && Vbat>3690) {
            percent = 20;
        }
    if (Vbat <=3690 && Vbat>3660) {
            percent = 15;
        }
    if (Vbat <=3660 && Vbat>3650) {
            percent = 12;
        }
    if (Vbat <=3650 && Vbat>3640) {
            percent = 10;
        }
    if (Vbat <=3640 && Vbat>3630) {
            percent = 8;
        }
    if (Vbat <=3630 && Vbat>3610) {
            percent = 5;
        }

    if (Vbat <=3610 && Vbat>3590) {
            percent = 3;
        }
    if (Vbat <=3590 ) {
            percent = 0;
